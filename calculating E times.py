...
"""
import sys
sys.path.insert(0, 'C:/Users/Jake/Documents/GitHub/gt_api')
...
#api_str = "http://localhost/api/v4"
#api_str = "http://sandbox.geysertimes.org/api/v4"
api_str = "http://www.geysertimes.org/api/v4"

gtapi.api_path = api_str
gtapip.api_path = api_str
...
'Castle': {'geyserID': 5, 'loggerID': 6, 'filter_width': 60, 'snr': 50, 'jump_or_max': 'first_jump', 'jump_window': 60},
...
'Oblong': {'geyserID': 23, 'loggerID': 15, 'filter_width': 60, 'snr': 15, 'jump_or_max': 'first_jump', 'jump_window': 120},
'Old Faithful': {'geyserID': 2, 'loggerID': 16, 'filter_width': 90, 'snr': 20, 'jump_or_max': 'first_jump', 'jump_window': 30},
