...
#'Daisy': {'geyserID': 4, 'loggerID': 7, 'filter_width': 60, 'snr': 50, 'jump_or_max': 'jump', 'jump_window': 120, 'duration': 0}
...
#'Lion': {'geyserID': 14, 'loggerID': 13, 'filter_width': 60, 'snr': 25, 'jump_or_max': 'max', 'jump_window': 10, 'duration': 0},
#'Little Squirt': {'geyserID': 36, 'loggerID': 14, 'filter_width': 60, 'snr': 10, 'jump_or_max': 'max', 'jump_window': 10, 'duration': 0},
#'Oblong': {'geyserID': 23, 'loggerID': 15, 'filter_width': 60, 'snr': 15, 'jump_or_max': 'max', 'jump_window': 120, 'duration': 0},
#'Old Faithful': {'geyserID': 2, 'loggerID': 16, 'filter_width': 60, 'snr': 50, 'jump_or_max': 'max', 'jump_window': 30, 'duration': 0},
